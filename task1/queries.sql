...
INSERT INTO tasks (title, description, user_id, status_id) VALUES ('New Task', 'Description', 1, 1);
...
SELECT status.name, COUNT(*) FROM tasks JOIN status ON tasks.status_id = status.id GROUP BY status.name;
